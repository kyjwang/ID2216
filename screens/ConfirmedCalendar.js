...
const ConfirmedCalendar = () => {
  ...
  return (
    <LinearGradient
      style={styles.confirmedcalendar}
    ...
    >
      <View style={styles.calendarEvents}>
        <View style={styles.weekdaysWeeks}>
          ...
          <View style={[styles.week02, styles.week02Layout]}>
            ...
            />
            <Text style={[styles.text10, styles.textTypo1]}>8</Text>
      ...
      <Text style={styles.productDevelopmentE7}>Product Development E7</Text>
      <Text style={[styles.communicationSeminarU4, styles.am12amTypo]}>
        Communication Seminar U4
      </Text>
      <Text style={[styles.dinnerHome, styles.pm9pmTypo]}>Dinner Home</Text>
      ...
      <Image
        style={[
          styles.confirmedcalendarChild,
          styles.confirmedcalendarChildLayout,
        ]}
        resizeMode="cover"
      ...
      />
      <Image
        style={[styles.lineIcon, styles.confirmedcalendarChildLayout]}
        resizeMode="cover"
        source={require("../assets/line-2.png")}
      />
      <Image
        style={[
          styles.confirmedcalendarChild1,
          styles.confirmedcalendarChildLayout,
        ]}
        resizeMode="cover"
        source={require("../assets/line-2.png")}
      ...
      >
        <Image
          style={[styles.chevronbackwardIcon, styles.text16Layout]}
          resizeMode="cover"
...
const styles = StyleSheet.create({
  ...
  confirmedcalendarChild: {
    top: 130,
    left: 0,
  },
  confirmedcalendarItem: {
    top: 443,
    left: -2,
  },
  confirmedcalendarInner: {
    top: 532,
    left: 2,
  },
  lineIcon: {
