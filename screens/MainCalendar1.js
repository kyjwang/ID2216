    ...
    >
      <View style={styles.statusBar}>
        <View style={styles.battery}>
          ...
          <Image
            style={[styles.capIcon, styles.arrowsPosition]}
            resizeMode="cover"
      ...
      <Text style={[styles.lecture, styles.examsTypo]}>Lecture</Text>
      <Text style={[styles.workouts, styles.examsTypo]}>Workouts</Text>
      <Text style={[styles.exams, styles.examsTypo]}>Exams</Text>
      <View
        style={[styles.nothingPlannedTodayHaveAWrapper, styles.wrapperLayout]}
      >
        <Text
          style={[styles.nothingPlannedToday, styles.reminderOneMoreTypo]}
        >{`Nothing planned Today! 
Have a good rest.`}</Text>
      </View>
      <View
        style={[styles.reminderOneMoreExerciseFoWrapper, styles.wrapperLayout]}
      >
        <Text
          style={[styles.reminderOneMore, styles.reminderOneMoreTypo]}
        >{`Reminder: 
...
`}</Text>
      ...
      <Image
        style={[styles.maincalendarChild, styles.maincalendarLayout]}
        resizeMode="cover"
        source={require("../assets/line-2.png")}
      />
      <Image
        style={[styles.maincalendarItem, styles.maincalendarLayout]}
        resizeMode="cover"
        source={require("../assets/line-2.png")}
      />
    </LinearGradient>
...
const styles = StyleSheet.create({
  ...
  reminderOneMoreExerciseFoWrapper: {
    top: 620,
    left: 30,
